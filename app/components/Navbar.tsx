...
export default function Navbar () {
    ...
    return <div className={`fixed z-50 h-4rem w-full  py-4 md:p-5 sm:text-sm bg-gradient-to-r from-blue-200 to-cyan-200 top-0 left-0   text-white md:border-b md:border-b-gray-500`} >
