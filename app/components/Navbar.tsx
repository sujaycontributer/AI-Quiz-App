...
export default function Navbar () {
    ...
    return <div className={`fixed z-50 md:max-w-[80%] mx-auto rounded-md shadow-md h-4rem w-full font-bold py-4 md:p-5 sm:text-sm bg-gradient-to-r from-blue-200 to-cyan-200 top-0 left-0 right-0 text-gray-800 md:border-b md:border-b-gray-500`} >
